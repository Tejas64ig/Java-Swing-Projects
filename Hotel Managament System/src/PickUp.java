...
public class PickUp extends JFrame {
    ...
    public PickUp() throws SQLException {
        DATA_BASE_CONNECTIVITY = Javaconnect.getDBConnection();
      ...
      table.setModel(DbUtils.resultSetToTableModel(rs)); //it Converts database ResultSet (rows from your SQL query
                                                                // directly into a JTable model so your table shows the data
